...
!function (a) {
    ...
    return function a(b, c, d) {
        ...
        18: [function (a, b) {
            b.exports = function (b) {
                ...
                e.add("data-uri", function (a, e) {
                    e || (e = a, a = null);
                    var h = a && a.value, i = e.value, j = e.currentFileInfo.relativeUrls ? e.currentFileInfo.currentDirectory : e.currentFileInfo.entryPath, k = i.indexOf("#"), l = "";
                    -1 !== k && (l = i.slice(k), i = i.slice(0, k));
                    var m = b.getFileManager(i, j, this.context, b, !0);
                    if (!m)return f(this, e);
                    var n = !1;
                    if (a)n = /;base64$/.test(h); else {
                        if (h = b.mimeLookup(i), "image/svg+xml" === h)n = !1; else {
        ...
        26: [function (a, b) {
            b.exports = function () {
                var b = a("../tree/dimension"), c = a("../tree/color"), d = a("../tree/quoted"), e = a("../tree/url"), f = a("./function-registry");
                f.add("svg-gradient", function (a) {
                    ...
                    var g, h, i, j, k, l, m, n = Array.prototype.slice.call(arguments, 1), o = "linear", p = 'x="0" y="0" width="1" height="1"', q = {compress: !1}, r = a.toCSS(q);
                    switch (r) {
                        case"to bottom":
        ...
        27: [function (a) {
            var b = a("../tree/keyword"), c = a("../tree/dimension"), d = a("../tree/color"), e = a("../tree/quoted"), f = a("../tree/anonymous"), g = a("../tree/url"), h = a("../tree/operation"), i = a("./function-registry"), j = function (a, c) {
                return a instanceof c ? b.True : b.False
            }, k = function (a, d) {
                if (void 0 === d)throw{type: "Argument", message: "missing the required second argument to isunit."};
        ...
        54: [function (a, b) {
            var c = a("./node"), d = a("./ruleset"), e = function (a, b, c, d, e, f) {
        ...
        73: [function (a, b) {
            var c = a("./node"), d = a("./rule"), e = a("./selector"), f = a("./element"), g = a("../contexts"), h = a("../functions/default"), i = a("./debug-info"), j = function (a, b, c) {
            ...
            j.prototype = new c, j.prototype.type = "Ruleset", j.prototype.isRuleset = !0, j.prototype.isRulesetLike = !0, j.prototype.accept = function (a) {
                ...
                var b, c, e, f, g = this.selectors, i = !1;
                if (g && (c = g.length)) {
                    for (b = [], h.error({
                        type: "Syntax",
                ...
                var k, l, m = this.rules ? this.rules.slice(0) : null, n = new j(b, m, this.strictImports);
                ...
                for (f = 0; q.length > f; f++)if (k = q[f], k instanceof j && k.selectors && 1 === k.selectors.length && k.selectors[0].isJustParentSelector()) {
                    q.splice(f--, 1);
                ...
                if (l = k.concat(l), !this.root) {
                    ...
                    for (n = a.compress ? "," : ",\n" + p, d = 0; s > d; d++)if (j = r[d], q = j.length)for (d > 0 && b.add(n), a.firstSelector = !0, j[0].genCSS(a, b), a.firstSelector = !1, e = 1; q > e; e++)j[e].genCSS(a, b);
                    b.add((a.compress ? "{" : " {\n") + o)
                }
                ...
                if (this.selectors)for (var a = 0; this.selectors.length > a; a++)this.selectors[a].markReferenced()
                ...
                if (h) {
                    for (r = [], i = [[]], d = 0; c.elements.length > d; d++)if (j = c.elements[d], "&" !== j.value)r.push(j); else {
                        for (s = [], r.length > 0 && this.mergeElementsOnToSelectors(r, i), e = 0; i.length > e; e++)if (k = i[e], 0 === b.length)k.length > 0 && (k[0].elements = k[0].elements.slice(0), k[0].elements.push(new f(j.combinator, "", j.index, j.currentFileInfo))), s.push(k); else for (g = 0; b.length > g; g++) {
                            if (l = b[g], m = [], n = [], p = !0, k.length > 0 ? (m = k.slice(0), q = m.pop(), o = c.createDerived(q.elements.slice(0)), p = !1) : o = c.createDerived([]), l.length > 1 && (n = n.concat(l.slice(1))), l.length > 0) {
                                p = !1;
                                var t = j.combinator, u = l[0].elements[0];
                ...
                } else if (b.length > 0)for (d = 0; b.length > d; d++)a.push(b[d].concat(c)); else a.push([c])
        ...
        81: [function (a, b) {
            var c = a("../tree"), d = a("./visitor"), e = function () {
            ...
            f.prototype = {
                run: function (a) {
                    ...
                    for (d = d || 0, e = 0; a.length > e; e++)for (f = 0; b.length > f; f++)j = a[e], k = b[f], j.parent_ids.indexOf(k.object_id) >= 0 || (i = [k.selfSelectors[0]], g = n.findMatch(j, i), g.length && j.selfSelectors.forEach(function (a) {

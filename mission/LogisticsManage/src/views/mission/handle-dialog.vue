  ...
  <el-dialog :title="vehicleInfo && vehicleInfo.smallLinkConvert" :visible.sync="value">
    <div v-if="isDeclareUpload">
      <el-form ref="dataForm" :rules="rules" :model="vehicleInfo" :disabled="disabled" label-position="left" label-width="150px" style="width: 550px">
        ...
        <el-form-item label="类型" prop="vehicleBaseInfo.type">
          <el-input v-model="vehicleInfo.vehicleBaseInfo.type" :disabled="true"></el-input>
        </el-form-item>

        <el-form-item label="是否有损" prop="vehicleBaseInfo.isDamage">
          <el-input v-model="DAMAGE_TYPE_LIST_OBJ[vehicleInfo.vehicleBaseInfo.isDamage]" :disabled="true"></el-input>
        </el-form-item>

        <el-form-item label="品牌" prop="vehicleBaseInfo.branding">
          <el-input v-model="vehicleInfo.vehicleBaseInfo.branding" :disabled="true"></el-input>
        </el-form-item>

        <el-form-item label="型号" prop="vehicleBaseInfo.vehicleModel">
          <el-input v-model="vehicleInfo.vehicleBaseInfo.vehicleModel" :disabled="true"></el-input>
        </el-form-item>

        <el-form-item label="颜色" prop="vehicleBaseInfo.vehicleColor">
          <el-input v-model="vehicleInfo.vehicleBaseInfo.vehicleColor" :disabled="true"></el-input>
        </el-form-item>

        <el-form-item label="钥匙数量" prop="vehicleBaseInfo.vehicleKey">
          <el-input v-model="vehicleInfo.vehicleBaseInfo.vehicleKey" :disabled="true"></el-input>
        </el-form-item>

        <el-form-item label="随车配件" prop="vehicleBaseInfo.carAccessories">
          <el-input v-model="vehicleInfo.vehicleBaseInfo.carAccessories" :disabled="true"></el-input>
        </el-form-item>
        ...
        <el-form-item label="上传报关资料" prop="vehicleDeclare.declareUrl">
          <Upload v-model="vehicleInfo.vehicleDeclare.declareUrl"
                  :multiple="true"
                  :disabled="isDeclareCheck"></Upload>
        </el-form-item>
    ...
    <div v-if="isFA">
      <el-form ref="dataForm" :model="vehicleInfo" :disabled="disabled" label-position="left" label-width="150px" style="width: 550px">
        <el-form-item label="车架号" prop="vehicleBaseInfo.vin">
          <el-input v-model="vehicleInfo.vin"></el-input>
        </el-form-item>

        <el-form-item label="类型" prop="vehicleBaseInfo.type">
          <el-input v-model="vehicleInfo.type"></el-input>
        </el-form-item>

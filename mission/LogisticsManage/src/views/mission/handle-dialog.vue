<template>
  <el-dialog v-if="vehicleInfo" :title="vehicleInfo.smallLinkConvert" :visible.sync="value">
    ...
    <div v-if="isFA">
      <el-form ref="dataForm" :model="vehicleInfo" :disabled="disabled" label-position="left" label-width="150px" style="width: 550px">
        <el-form-item label="车架号" prop="vehicleBaseInfo.vin">
          <el-input v-model="vehicleInfo.vin"/>
        </el-form-item>

        <el-form-item label="类型" prop="vehicleBaseInfo.type">
          <el-input v-model="vehicleInfo.type"/>
        </el-form-item>
    ...
    <!--<el-table :key="listKey" :data="vehicleInfo.vehicleAbroadFreeList" border fit highlight-current-row>-->
    <!--<el-table-column label="车架号" prop="name" align="center" width="125">-->
    <!--<template slot-scope="{row}">-->
    <!--<span>{{ row.name }}</span>-->
    <!--</template>-->
    <!--</el-table-column>-->

    <!--<el-table-column label="到达地" prop="free" align="center" width="125">-->
    <!--<template slot-scope="{row}">-->
    <!--<span>{{ row.free }}</span>-->
    <!--</template>-->
    <!--</el-table-column>-->

    <!--<el-table-column label="更新时间" prop="photoUrl" align="center" width="125">-->
    <!--<template slot-scope="{row}">-->
    <!--<img width="100" :src="row.photoUrl"/>-->
    <!--</template>-->
    <!--</el-table-column>-->
    ...
    <!--<el-form-item label="部门经理审批" prop="vehicleBaseInfo.company">-->
    <!--<el-input v-model="vehicleInfo.company"/>-->
    <!--</el-form-item>-->
    <!--</el-form>-->

    <!--<div slot="footer" class="dialog-footer">-->
    <!--<el-button type="primary" @click="handleData(vehicleInfo)">拒绝出库</el-button>-->

    <!--<el-button type="primary" @click="handleData(vehicleInfo)">允许出库</el-button>-->
    <!--</div>-->
    <!--</div>-->
  </el-dialog>
</template>

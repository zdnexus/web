...
define("echarts/config", [], function () {
    ...
    return document.createElement("canvas").getContext ? G_vmlCanvasManager = !1 : function () {
        ...
        q.clearRect = function () {
            ...
            var u = this.m_, a = 1e3, f = 0, l = a, c = {
                x: 0,
                y: 0
            }, p = [], d = H(P(this.font), this.element_), v = B(d), m = this.element_.currentStyle, g = this.textAlign.toLowerCase();
            switch (g) {
                case"left":
                case"center":
                case"right":
    ...
    var t = e("./config"), n = e("./tool/env"), r = e("./tool/event"), i = t.EVENT, s = ["resize", "click", "mousewheel", "mousemove", "mouseout", "mouseup", "mousedown", "touchstart", "touchend", "touchmove"], o = {
        resize: function (e) {
    ...
    f.prototype.on = function (e, t) {
        ...
        var i = "on" + t, s = {type: t, event: n, target: e};
        r && (s.dragged = r), e ? (!e[i] || !e[i](s)) && this.dispatch(t, n, s) : r || this.dispatch(t, n)
    };
    var l = [{x: 10}, {x: -20}, {x: 10, y: 10}, {y: -20}];
    ...
    var t = e("../tool/util"), n, r = ["#ff9277", " #dddd00", " #ffc877", " #bbe3ff", " #d5ffbb", "#bbbbff", " #ddb000", " #b0dd00", " #e2bbff", " #ffbbe3", "#ff7777", " #ff9900", " #83dd00", " #77e3ff", " #778fff", "#c877ff", " #ff77ab", " #ff6600", " #aa8800", " #77c7ff", "#ad77ff", " #ff77ff", " #dd0083", " #777700", " #00aa00", "#0088aa", " #8400dd", " #aa0088", " #dd0000", " #772e00"], i = r, s = "rgba(255,255,0,0.5)", o = s, u = /^\s*((#[a-f\d]{6})|(#[a-f\d]{3})|rgba?\(\s*([\d\.]+%?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+%?(?:\s*,\s*[\d\.]+%?)?)\s*\)|hsba?\(\s*([\d\.]+(?:deg|\xb0|%)?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+%?(?:\s*,\s*[\d\.]+)?)%?\s*\)|hsla?\(\s*([\d\.]+(?:deg|\xb0|%)?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+%?(?:\s*,\s*[\d\.]+)?)%?\s*\))\s*$/i, a = {
        aliceblue: "#f0f8ff",
        antiquewhite: "#faebd7",
        aqua: "#0ff",
        aquamarine: "#7fffd4",
    ...
    var t = e("../tool/matrix"), n = e("../tool/guid");
    ...
    var o = [["color", "fillStyle"], ["strokeColor", "strokeStyle"], ["opacity", "globalAlpha"], ["lineCap"], ["lineJoin"], ["miterLimit"], ["lineWidth"], ["shadowBlur"], ["shadowColor"], ["shadowOffsetX"], ["shadowOffsetY"]];
    return s.prototype.setContext = function (e, t) {
        for (var n = 0, r = o.length; n < r; n++) {
            var i = o[n][0], s = t[i], u = o[n][1] || i;
        ...
        e.fillStyle = i;
        var s = 10, o, u, a, f, l = t.textPosition || this.textPosition || "top";
        switch (l) {
            case"inside":
            case"top":
            case"bottom":
        ...
        if (this.scale && (this.scale[0] !== 1 || this.scale[1] !== 1)) {
            var r = this.scale[2] || 0, i = this.scale[3] || 0;
        ...
        if (this.rotation)if (this.rotation instanceof Array) {
            if (this.rotation[0] !== 0) {
                var r = this.rotation[1] || 0, i = this.rotation[2] || 0;
    ...
    var t = e("./Base");
    return n.prototype = {
        type: "path", _parsePathData: function (e) {
            if (!e)return [];
    ...
    var t = {}, n = [], r, i = e("./Base");
    return s.prototype = {
        type: "image", brush: function (e, i, s) {
            var o = this.style || {};
    ...
    function l(e, t, n) {
        var r = document.createElement(t), i = n._width, o = n._height;
    ...
    var t = e("./config"), n = e("./tool/util"), r = e("./tool/log"), i = e("./loadingEffect/Base"), s = window.devicePixelRatio || 1, o = window.G_vmlCanvasManager;
    return f.prototype.render = function (e) {
        return this.isLoading() && this.hideLoading(), this._syncMaxZlevelCanvase(), this.clear(), this.storage.iterShape(this._brush({all: !0}), {normal: "up"}), this.storage.clearChangedZlevel(), typeof e == "function" && e(), this
    }, f.prototype.refresh = function (e) {
        this._syncMaxZlevelCanvase();
        var t = this.storage.getChangedZlevel();
        if (t.all)this.clear(); else for (var n in t)this._ctxList[n] && this.clearLayer(n);
        return this.storage.iterShape(this._brush(t), {normal: "up"}), this.storage.clearChangedZlevel(), typeof e == "function" && e(), this
        ...
        var e = this;
        return this.clearHover(), this.storage.iterShape(t, {hover: !0}), this.storage.delHover(), this
        ...
        if (t) {
            var n = typeof t.clearColor != "undefined", r = t.motionBlur, i = t.lastFrameAlpha;
        ...
        var n = this._ctxList, i = this;
        return function (i) {
            if ((e.all || e[i.zlevel]) && !i.invisible) {
                var o = n[i.zlevel];
                if (o) {
                    if (!i.onbrush || i.onbrush && !i.onbrush(o, !1))if (t.catchBrushException)try {
                        i.brush(o, !1, s)
                    } catch (u) {
        ...
        var n = this._ctxList.hover, i = this;
        ...
        var f = e("./shape/Image"), l = new f({id: t, style: {x: 0, y: 0, image: s.toDataURL()}});
        ...
        if (o)return a;
        var e = this, t = document.createElement("canvas"), n = t.getContext("2d"), r = window.devicePixelRatio || 1;
    ...
    var t = e("./tool/util"), n = e("./tool/log"), r = e("./config");
    return i.prototype.iterShape = function (e, t) {
        t || (t = {hover: !1, normal: "down"});
        if (t.hover)for (var n = 0, r = this._hoverElements.length; n < r; n++)if (e(this._hoverElements[n]))return this;
        var i, s;
        if (typeof t.normal != "undefined")switch (t.normal) {
            ...
            case"up":
                for (var n = 0, r = this._zElements.length; n < r; n++) {
                    ...
                    if (i) {
                        s = i.length;
                        for (var o = 0; o < s; o++)if (e(i[o]))return this
                    }
                }
                break;
            default:
                for (var n in this._elements)if (e(this._elements[n]))return this
        }
        return this
        ...
        if (s) {
            s.needTransform = !0;
            if (!s.ondrift || s.ondrift && !s.ondrift(t, i))if (r.catchBrushException)try {
                s.drift(t, i)
            } catch (o) {
        ...
        if (typeof e != "undefined") {
            ...
            var i, s, o, u = {};
            for (var a in t)if (this._elements[a]) {
        ...
        } else this._elements = {}, this._zElements = [], this._hoverElements = [], this._maxZlevel = 0, this._changedZlevel = {all: !0};
        return this
    ...
    function f(e, t, n, r, i) {
        var s = e.length;
        if (i == 1)for (var o = 0; o < s; o++)r[o] = a(e[o], t[o], n); else {
            var u = e[0].length;
            for (var o = 0; o < s; o++)for (var f = 0; f < u; f++)r[o][f] = a(e[o][f], t[o][f], n)
        }
    }
    ...
    function c(e, t, n, r, i, s, o, u, a) {
        var f = e.length;
        if (a == 1)for (var l = 0; l < f; l++)u[l] = h(e[l], t[l], n[l], r[l], i, s, o); else {
            var c = e[0].length;
            for (var l = 0; l < f; l++)for (var p = 0; p < c; p++)u[l][p] = h(e[l][p], t[l][p], n[l][p], r[l][p], i, s, o)
        }
    }
    ...
    var t = e("./clip"), n = e("../tool/color"), r = window.requestAnimationFrame || window.msRequestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || function (e) {
            setTimeout(e, 16)
    ...
    return s.prototype = {
        ...
        when: function (e, t) {
            ...
            var r = this, i = this._setter, s = this._getter, o = r._onframeList.length, u = e === "spline", p = function () {
                r._clipCount--;
                if (r._clipCount === 0) {
                    r._tracks = {};
                ...
                var g = v.length;
                if (!g)return;
                var y = v[0].value, b = l(y), w = !1, E = b && l(y[0]) ? 2 : 1;
                v.sort(function (e, t) {
                ...
                var B = function (e, t) {
                    ...
                    if (u) {
                        ...
                        if (b)c(M, _, D, P, O, O * O, O * O * O, s(e, m), E); else {
                            var l;
                            w ? (l = c(M, _, D, P, O, O * O, O * O * O, H, 1), l = d(H)) : l = h(M, _, D, P, O, O * O, O * O * O), i(e, m, l)
                        }
                    } else if (b)f(T[N], T[N + 1], O, s(e, m), E); else {
                        var l;
                        w ? (f(T[N], T[N + 1], O, H, 1), l = d(H)) : l = a(T[N], T[N + 1], O), i(e, m, l)
                    }
                    for (N = 0; N < o; N++)r._onframeList[N](e, t)
                }, j = new t({target: r._target, life: S, loop: r._loop, delay: r._delay, onframe: B, ondestroy: p});
    ...
    function c(t, n) {
        this.id = t, this.env = e("./tool/env"), this.storage = new o, this.painter = new s(n, this.storage), this.handler = new i(n, this.storage, this.painter), this.animatingShapes = [], this.animation = new u({stage: {update: l(this)}}), this.animation.start()
    }
    ...
    function u(e, n, s, u) {
        ...
        e.modShape(p.id, {scale: [.1, .1, g, y]}), e.animate(p.id, "", !0).when(m, {scale: [1, 1, g, y]}).start()
    }

    function a(e, t, n, r) {
        var i = n.effect, o = i.color || n.style.strokeColor || n.style.color, u = i.scaleSize, a = i.shadowColor || o, f = typeof i.shadowBlur != "undefined" ? i.shadowBlur : u * 2, l = window.devicePixelRatio || 1, c = new s({
            zlevel: r,
            position: n.position,
            scale: n.scale,
            style: {
    ...
    function f(e, i, s, u) {
        var a = s.effect, f = a.color || s.style.strokeColor || s.style.color, l = a.shadowColor || s.style.strokeColor || f, c = s.style.lineWidth * a.scaleSize, h = typeof a.shadowBlur != "undefined" ? a.shadowBlur : c, p = new n({
            zlevel: u,
        ...
        if (!s.style.smooth)e.animate(p.id, "style", !0).when(m, {x: s._x - d, y: s._y - d}).start(); else {
            var g = s.style.pointList || s.getPointList(s.style), y = g.length;
            m = Math.round(m / y);
            var b = e.animate(p.id, "style", !0), w = Math.ceil(y / 8);
            for (var E = 0; E < y - w; E += w)b.when(m * (E + 1), {x: g[E][0] - d, y: g[E][1] - d});
            b.when(m * y, {x: g[y - 1][0] - d, y: g[y - 1][1] - d}), b.start("spline")
        }
    }
    ...
    return a.prototype = {
        type: i.CHART_TYPE_ISLAND, _combine: function (t, n) {
            ...
            var t = s.get(e, "name"), n = s.get(e, "value"), i = typeof s.get(e, "series") != "undefined" ? s.get(e, "series").name : "", o = this.getFont(this.option.island.textStyle), u = {
    ...
    return d.prototype = {
        ...
        _showPolarTrigger: function (e, t) {
            ...
            if (r.length > 0) {
                ...
                if (typeof i == "function")this._curTicket = "axis:" + t, this._tDom.innerHTML = i(d, this._curTicket, this._setContent); else if (typeof i == "string") {
        ...
        _showItemTrigger: function () {
            ...
            if (typeof a == "function")this._curTicket = (e.name || "") + ":" + u.get(this._curTarget, "dataIndex"), this._tDom.innerHTML = a([e.name || "", n, r, i, s], this._curTicket, this._setContent); else if (typeof a == "string")this._curTicket = NaN, a = a.replace("{a}", "{a0}").replace("{b}", "{b0}").replace("{c}", "{c0}"), a = a.replace("{a0}", this._encodeHTML(e.name || "")).replace("{b0}", this._encodeHTML(n)).replace("{c0}", r instanceof Array ? r : this.numAddCommas(r)), a = a.replace("{d}", "{d0}").replace("{d0}", i || ""), a = a.replace("{e}", "{e0}").replace("{e0}", u.get(this._curTarget, "special2") || ""), this._tDom.innerHTML = a; else {
                this._curTicket = NaN;
        ...
        showTip: function (e) {
            ...
            var l = myChart.chart[f.type], c = this.deepQuery([f, this.option], "tooltip.trigger") == "axis";
            if (!l)return;
            if (c) {
                var h = e.dataIndex;
                switch (l.type) {
    ...
    l.prototype = {
        type: u.COMPONENT_TYPE_LEGEND, _buildShape: function () {
            ...
            var e = this.legendOption.data, t = e.length, r, i, o, u, l = this.legendOption.textStyle, c, h, p = this.zr.getWidth(), d = this.zr.getHeight(), v = this._itemGroupLocation.x, m = this._itemGroupLocation.y, g = this.legendOption.itemWidth, y = this.legendOption.itemHeight, b = this.legendOption.itemGap, w;
            ...
            for (var E = 0; E < t; E++) {
                ...
                i = e[E].icon || this._getSomethingByName(r).type, w = this.getColor(r), this.legendOption.orient == "horizontal" ? p - v < 200 && g + 5 + f.getTextWidth(r, h) + (E == t - 1 || e[E + 1] === "" ? 0 : b) >= p - v && (v = this._itemGroupLocation.x, m += y + b) : d - m < 200 && y + (E == t - 1 || e[E + 1] === "" ? 0 : b) >= d - m && (this.legendOption.x == "right" ? v -= this._itemGroupLocation.maxWidth + b : v += this._itemGroupLocation.maxWidth + b, m = this._itemGroupLocation.y), o = this._getItemShapeByType(v, m, g, y, this._selectedMap[r] ? w : "#ccc", i, w), o._name = r, o = new s(o), u = {
                    ...
                    highlightStyle: {color: w, brushType: "fill"},
    ...
    return n.inherits(s, t), s.prototype._start = function (e, t) {
        ...
        }), o = this.createTextShape(s.textStyle), u = this.createBackgroundShape(s.backgroundColor), a = s.effectOption, f = new i({highlightStyle: n.clone(a)});
    ...
    return n.inherits(s, t), s.prototype._start = function (e, t) {
        ...
        }), o = this.createTextShape(s.textStyle), u = this.createBackgroundShape(s.backgroundColor), a = s.effect, f = a.n, l = a.brushType, c = a.lineWidth, h = [];
        for (var p = 0; p < f; p++) {
    ...
    return n.inherits(s, t), s.prototype._start = function (e, t) {
        ...
        }), o = this.createTextShape(s.textStyle), u = this.createBackgroundShape(s.backgroundColor), a = s.effectOption, f = a.n, l = a.lineWidth, c = [];
        for (var h = 0; h < f; h++) {
            var p = -Math.ceil(Math.random() * 1e3), d = Math.ceil(Math.random() * 400), v = Math.ceil(Math.random() * this.canvasHeight), m = a.color == "random" ? r.random() : a.color;
            c[h] = new i({
                highlightStyle: {xStart: p, yStart: v, xEnd: p + d, yEnd: v, strokeColor: m, lineWidth: l},
    ...
    return n.inherits(s, t), s.prototype._start = function (e, t) {
        var s = n.merge(this.options.effect || {}, {
            ...
            textStyle: {color: "#fff", x: s.x + s.r + 10, y: s.y, textAlign: "start"},
            backgroundColor: "rgba(0, 0, 0, 0.8)"
        }), u = this.createTextShape(o.textStyle), a = this.createBackgroundShape(o.backgroundColor), f = s.n, l = s.x, c = s.y, h = s.r0, p = s.r, d = s.color, v = [], m = Math.round(180 / f);
    ...
    return n.inherits(o, t), o.prototype._start = function (e, t) {
        var o = n.merge(this.options.effect || {}, {
            ...
            textStyle: {color: "#888", x: o.x + o.r + 10, y: o.y, textAlign: "start"},
            backgroundColor: "rgba(250, 250, 250, 0.8)"
        }), a = this.createTextShape(u.textStyle), f = this.createBackgroundShape(u.backgroundColor), l = new i({
            highlightStyle: {
                a: Math.round(o.r / 2),
    ...
    var t = e("./config"), n = e("zrender/tool/util"), r = {}, i = e("zrender/tool/env").canvasSupported, s = new Date - 0, o = {}, u = "_echarts_instance_";
    r.version = "2.0.0", r.dependencies = {zrender: "2.0.0"}, r.init = function (t, n) {
        var i = e("zrender");
    ...
    var f = e("zrender/config").EVENT, l = ["CLICK", "MOUSEOVER", "DRAGSTART", "DRAGEND", "DRAGENTER", "DRAGOVER", "DRAGLEAVE", "DROP"];
    return a.prototype = {
        _init: function () {
            ...
            this._status = {dragIn: !1, dragOut: !1, needRefresh: !1}, c(this, "ondragstart", e)
    ...
    var t = e("../component/base"), n = e("./base"), r = e("../util/shape/GaugePointer"), i = e("zrender/shape/Text"), s = e("zrender/shape/Line"), o = e("zrender/shape/Rectangle"), u = e("zrender/shape/Circle"), a = e("zrender/shape/Sector"), f = e("../config"), l = e("../util/ecData"), c = e("zrender/tool/util"), h = e("zrender/tool/math"), p = e("zrender/tool/color");
    return d.prototype = {
        type: f.CHART_TYPE_GAUGE, _buildShape: function () {
            ...
            var n = t.min, r = t.max - n, i = this._paramsMap[e], s = i.center, o = i.startAngle, u = i.totalAngle, a = i.colorArray, f = t.axisLine.lineStyle, c = this.parsePercent(f.width, i.radius[1]), h = i.radius[1], p = h - c, d, v = a.length, m = o, g;
            ...
            var n = this._paramsMap[e], r = t.splitNumber, i = t.min, o = t.max - i, u = t.splitLine, a = this.parsePercent(u.length, n.radius[1]), f = u.lineStyle, l = f.color, c = n.center, h = n.startAngle * Math.PI / 180, p = n.totalAngle * Math.PI / 180, d = n.radius[1], v = d - a, m, g, y, b;
            ...
            var n = this._paramsMap[e], r = t.splitNumber, i = t.min, o = t.max - i, u = t.axisTick, a = u.splitNumber, f = this.parsePercent(u.length, n.radius[1]), l = u.lineStyle, c = l.color, h = n.center, p = n.startAngle * Math.PI / 180, d = n.totalAngle * Math.PI / 180, v = n.radius[1], m = v - f, g, y, b, w;
            ...
            var n = t.splitNumber, r = t.min, s = t.max - r, o = t.axisLabel.textStyle, u = this.getFont(o), a = o.color, f = this._paramsMap[e], l = f.center, c = f.startAngle, h = f.totalAngle, p = f.radius[1] - this.parsePercent(t.splitLine.length, f.radius[1]) - 10, d, v, m, g, y;
            ...
            c = c < t.max ? c : t.max;
            var h = (s.startAngle - s.totalAngle / n * (c - t.min)) * Math.PI / 180, p = i.color == "auto" ? this._getColor(e, c) : i.color, d = new r({
                zlevel: this._zlevelBase + 1,
                style: {
                    x: f[0],
                    y: f[1],
    ...
    var t = e("../component/base"), n = e("./base"), r = e("zrender/shape/Text"), i = e("zrender/shape/Line"), s = e("zrender/shape/Rectangle"), o = e("zrender/shape/Polygon"), u = e("zrender/shape/Circle"), a = e("zrender/shape/Sector"), f = e("../config"), l = e("../util/ecData"), c = e("../util/number"), h = e("zrender/tool/util"), p = e("zrender/tool/math"), d = e("zrender/tool/color"), v = e("zrender/tool/area");
    return m.prototype = {
        type: f.CHART_TYPE_FUNNEL, _buildShape: function () {
            var e = this.series, t = this.component.legend;
            this._paramsMap = {}, this._selected = {}, this.selectedMap = {};
            var n;
            for (var r = 0, i = e.length; r < i; r++)if (e[r].type == f.CHART_TYPE_FUNNEL) {
            ...
            if (o === 0)return;
            var l = this._buildFunnelCase(e), h = n.gap, p = o > 1 ? (i.height - (o - 1) * h) / o : i.height, d, v = i.y, m = n.sort == "descending" ? this._getItemWidth(e, u[0].value) : c.parsePercent(n.minSize, i.width), g = n.sort == "descending" ? 1 : 0, y = i.centerX, b = [[y - m / 2 - (m == 0 ? 0 : 10), v - (m == 0 ? 10 : 5)], [y + m / 2 + (m == 0 ? 0 : 10), v - (m == 0 ? 10 : 5)]];
            ...
            if (this.deepQuery([t, this.option], "calculable")) {
                var n = this._paramsMap[e].location, r = n.centerX, i = c.parsePercent(t.minSize, n.width) / 2, s = c.parsePercent(t.maxSize, n.width) / 2, u = 10, a = {
                    hoverable: !1,
                    style: {
                        pointListd: [[n.x - u, n.y - u], [n.x + n.width + u, n.y - u], [n.x + n.width + u, n.y + n.height + u], [n.x - u, n.y + n.height + u]],
                        brushType: "stroke",
                        lineWidth: 1,
            ...
            var t = this.series[e], n = h.clone(t.data);
            ...
            var a = this.series, f = a[e], c = f.data[t], h = this.getPolygon(e, t, n, r, i, s, o, u);
            ...
            var n = this.series[e], r = this._paramsMap[e].location, i = n.min, s = n.max, o = c.parsePercent(n.minSize, r.width), u = c.parsePercent(n.maxSize, r.width);
            return t * (u - o) / (s - i)
        }, getPolygon: function (e, t, n, r, i, s, u, a) {
            var f = this.series[e], l = f.data[t], c = [l, f], h = this.deepMerge(c, "itemStyle.normal") || {}, p = this.deepMerge(c, "itemStyle.emphasis") || {}, v = this.getItemStyleColor(h.color, e, t, l) || n, m = this.getItemStyleColor(p.color, e, t, l) || (typeof v == "string" ? d.lift(v, -0.2) : v), g = {
                zlevel: this._zlevelBase,
                clickable: !0,
                style: {
                    pointList: [[r, i], [r + s, i], [r + s - (s - u) / 2, i + a], [r + (s - u) / 2, i + a]],
                    brushType: "both",
                    color: v,
                    lineWidth: h.borderWidth,
                    strokeColor: h.borderColor
                },
                highlightStyle: {color: m, lineWidth: p.borderWidth, strokeColor: p.borderColor}
            };
            ...
            var f = this.series[e], l = f.data[t], c = this._paramsMap[e].location, p = h.merge(h.clone(l.itemStyle) || {}, f.itemStyle), m = "normal", g = p[m].label, y = g.textStyle || {}, b = p[m].labelLine.length, w = this.getLabelText(e, t, m), E = this.getFont(y), S, x, T = n;
            ...
            var f = this.series[e], l = f.data[t], c = this._paramsMap[e].location, p = h.merge(h.clone(l.itemStyle) || {}, f.itemStyle), d = "normal", v = p[d].labelLine, m = p[d].labelLine.length, g = v.lineStyle || {}, y = p[d].label;
        ...
        type: s.COMPONENT_TYPE_AXIS_VALUE, _buildShape: function () {
            ...
            if (this.isHorizontal()) {
                ...
                for (var h = 0; h < n; h++)c = this.subPixelOptimize(this.getCoord(t[h]), o), e = {
                    zlevel: this._zlevelBase,
                    hoverable: !1,
                    style: {xStart: c, yStart: f, xEnd: c, yEnd: l, strokeColor: u[h % a], lineType: s, lineWidth: o}
                }, this.shapeList.push(new r(e))
            } else {
                ...
                for (var h = 0; h < n; h++)v = this.subPixelOptimize(this.getCoord(t[h]), o), e = {
                    zlevel: this._zlevelBase,
                    hoverable: !1,
                    style: {xStart: p, yStart: v, xEnd: d, yEnd: v, strokeColor: u[h % a], lineType: s, lineWidth: o}
                }, this.shapeList.push(new r(e))
            }
        }, _buildSplitArea: function () {
            ...
            if (e)for (var t = 0, n = this._valueList.length; t < n; t++)typeof e == "function" ? this._valueLabel.push(e(this._valueList[t])) : typeof e == "string" && this._valueLabel.push(e.replace("{value}", this._valueList[t])); else for (var t = 0, n = this._valueList.length; t < n; t++)this._valueLabel.push(this.numAddCommas(this._valueList[t]))
    ...
    return u.prototype = {
        type: r.COMPONENT_TYPE_AXIS, axisBase: {
            _buildAxisLine: function () {
                var e = this.option.axisLine.lineStyle.width, t = e / 2, r = {
                    _axisShape: "axisLine",
                    zlevel: this._zlevelBase + 1,
                    hoverable: !1
                };
    ...
    return u.prototype = {
        type: s.COMPONENT_TYPE_DATAZOOM, _buildShape: function () {
            ...
            }, this, "xAxis"), u = this.option.series[t].xAxisIndex || 0;
    ...
    var t = e("./base"), n = e("zrender/shape/Text"), r = e("zrender/shape/Line"), i = e("zrender/shape/Polygon"), s = e("../config"), o = e("zrender/tool/util"), u = e("../util/coordinates");
    return a.prototype = {
        type: s.COMPONENT_TYPE_POLAR, _buildShape: function () {
            ...
            var t = this.polar[e], n = this.deepQuery(this._queryTarget, "indicator"), r = n.length, i = t.startAngle, s = 2 * Math.PI / r, o = this.parsePercent(t.radius, Math.min(this.zr.getWidth(), this.zr.getHeight()) / 2), a = t.__ecIndicator = [], f;
            for (var l = 0; l < r; l++)f = u.polar2cartesian(o, i * Math.PI / 180 + s * l), a.push({vector: [f[1], -f[0]]})
            ...
            var t = this.polar[e], r = this.deepQuery(this._queryTarget, "indicator"), i = t.__ecIndicator, s, u, a, f, l = this.deepQuery(this._queryTarget, "splitNumber"), c = this.getCenter(e), u, h, p, d, v, m = this.deepQuery(this._queryTarget, "precision");
            ...
            var e = e || 0, t = this.polar[e], n = this.getCenter(e), r = t.__ecIndicator, i = r.length, s = [], o, u;
            ...
            var t = [], n, r, i = this.component.legend;
            ...
            for (var h = 0; h < this.polar.length; h++) {
                ...
                if (e[0] == n[0] && e[1] == n[1])return {polarIndex: h, valueIndex: 0};
    ...
    return a.prototype = {
        type: i.CHART_TYPE_RADAR, _buildShape: function () {
            ...
            var f = this.series, l = [n, this.serie], c = this.getItemStyleColor(this.deepQuery(l, "itemStyle.normal.color"), i, o, n), h = this.deepQuery(l, "itemStyle.normal.lineStyle.width"), p = this.deepQuery(l, "itemStyle.normal.lineStyle.type"), d = this.deepQuery(l, "itemStyle.normal.areaStyle.color"), v = this.deepQuery(l, "itemStyle.normal.areaStyle"), m = {
                zlevel: this._zlevelBase,
                style: {
                    pointList: e,
    ...
    return p.prototype = {
        type: u.CHART_TYPE_CHORD, _buildShape: function () {
            ...
            for (var m = 0; m < n; m++) {
                var g = this.groups[m], y = e[m], b = (this.clockWise ? 360 - y[1] : y[0]) + this.startAngle, w = (this.clockWise ? 360 - y[0] : y[1]) + this.startAngle, E = {
                    zlevel: this._zlevelBase,
                    style: {
                        x: this.center[0],
                        y: this.center[1],
            ...
            for (var u = 0; u < n; u++)for (var f = 0; f < n; f++)for (var l = 0; l < r; l++) {
                ...
                var m = this.clockWise ? c : 360 - p, g = this.clockWise ? p : 360 - c, y = this.clockWise ? h : 360 - d, b = this.clockWise ? d : 360 - h, w = {
                    zlevel: this._zlevelBase,
                    style: {
                        center: this.center,
                        r: this.innerRadius,
    ...
    function v(e, v, y, b, w) {
        function rt() {
            ...
            for (var t = 0, n = T.length; t < n; t++) {
                ...
                if (r.type === o.CHART_TYPE_FORCE) {
                    ...
                    x.buildMark(t), N = r;
                    var i = x.query(r, "minRadius"), s = x.query(r, "maxRadius");
        ...
        function st(e, t, n) {
            ...
            for (var o = 0; o < s; o++) {
                ...
                u.pack(E, {name: _}, 0, f, a.indexOf(P, f), f.name || "", f.value), E = new r(E), C.push(E), x.shapeList.push(E), y.addShape(E)
            }
        }
        ...
        function ot(e, t) {
            ...
            for (var r = 0; r < n; r++) {
                ...
                var l = B[o.source], c = B[o.target], o = H[o.rawIndex];
                u.pack(f, N, 0, {
                    source: o.source,
                    target: o.target,
                    weight: o.weight || 0
        ...
        function ut() {
            ...
            for (var t = 0, n = j.length; t < n; t++) {
                var r = j[t], i = k[t], s = C[r.source], o = C[r.target];
        ...
        function at(e) {
            ...
            for (var i = 0, p = j.length; i < p; i++) {
                var v = j[i], m = I[i], g = v.source, y = v.target, a = R[g], f = R[y];
                c.sub(n, f, a);
            ...
            for (var i = 0, p = B.length; i < p; i++) {
                var w = R[i];
                c.sub(n, et, w);
                var b = c.lengthSquare(n), h = b * K / (100 * Math.sqrt(b));
                c.scaleAndAdd(q[i], q[i], n, h)
            }
            var E = [];
            for (var i = 0, p = R.length; i < p; i++) {
                var S = B[i], x = B[i].name;
                if (B[i].fixed) {
        ...
        var E = w.component, S, x = this;
        x.type = o.CHART_TYPE_FORCE;
        var T, N, C = [], k = [], L = [], A = [], O, M, _, D, P, H, B = [], j = [], F = [], I = [], q = [], R = [], U = [], z = [], W, X, V, $, J, K, Q, G = 1 / 60, Y, Z, et = [], tt, nt, lt;
    ...
    var t = e("../component/base"), n = e("./base"), r = e("zrender/shape/Circle"), i = e("zrender/shape/Line"), s = e("../util/shape/Icon"), o = e("../config"), u = e("../util/ecData"), a = e("zrender/tool/util"), f = e("zrender/config"), l = e("zrender/tool/event"), c = e("zrender/tool/vector"), h = e("../util/ndarray"), p = window.requestAnimationFrame || window.msRequestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || function (e) {
            setTimeout(e, 16)
        }, d = {};
    ...
    return a.prototype = {
        type: i.CHART_TYPE_BAR, _buildShape: function () {
            ...
            var r = this.series, i = {}, s = {}, o, u = 0, a = 0, f, l, c, h, p = 1;
            ...
            } else E = e.getGap(), f = 0, S = Math.floor(E / t.length), S <= 0 && (p = Math.floor(t.length / E), S = 1); else {
            ...
            return {barWidthMap: i, barMinHeightMap: s, gap: E, barWidth: S, barGap: f, interval: p}
    ...
    return p.prototype = {
        type: a.CHART_TYPE_PIE, _buildShape: function () {
            ...
            var l = this.series, p = l[e], d = p.data[t], v = [d, p], m = this.parseCenter(this.zr, p.center), g = this.deepMerge(v, "itemStyle.normal") || {}, y = this.deepMerge(v, "itemStyle.emphasis") || {}, b = this.getItemStyleColor(g.color, e, t, d) || f, w = this.getItemStyleColor(y.color, e, t, d) || (typeof b == "string" ? h.lift(b, -0.2) : b), E = {
                zlevel: this._zlevelBase,
                clickable: !0,
                style: {
                    x: m[0],

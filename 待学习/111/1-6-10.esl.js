...
!function (e) {
    ...
    function t() {
        ...
        if (e) {
            ...
            r ? (a(r, n, t), H && clearTimeout(H), H = setTimeout(o, 1)) : rr.push({deps: n, factory: t})
        }
    }
            ...
            if (!(r.state > P)) {
                ...
                "function" == typeof a && (i = Math.min(a.length, t), a.toString().replace(G, "").replace(Q, function (e, r, t) {
                    ...
                    c && !er[c] ? (s.resource && (u = {
                        ...
                        hard: i > a,
                        circular: W
                    }, r.depMs.push(o), r.depMsIndex[c] = o, e(c))) : o = {absId: c}, t > a && r.factoryDeps.push(u || o)
        ...
        function t() {
            if (!(r.state >= L)) {
                ...
                if (t >= K && i(), !(V > t)) {
                    ...
                    var u = v(o, {require: r.require, exports: r.exports, module: r});
                    try {
                        var s = r.factory, c = "function" == typeof s ? s.apply(e, u) : s;
                        null != c && (r.exports = c)
                    } catch (f) {
    ...
    function M(e, r) {
        ...
        function t(t) {
            ...
            t.load(a.resource, o, n, i.call({id: e}))
        }

        if (!F[e]) {
            var a = U(e), o = {id: e, state: B};
    ...
    function E(e, r) {
        ...
        var n = U(e);
        if (!n)return e;
        var t = n.resource, i = S(n.module, r);
        if (A(ar, function (e) {
                var r = e.name;
    ...
    function S(e, r) {
        if (0 === e.indexOf(".")) {
            var n = r.split("/"), t = e.split("/"), i = n.length - 1, a = t.length, o = 0, u = 0;
            e:for (var s = 0; a > s; s++) {
                var c = t[s];
                switch (c) {
                    case"..":
    ...
    function U(e) {
        var r = e.split("!");
        return dr.test(r[0]) ? {module: r[0], resource: r[1]} : null
    }

    function O(e) {
        var r = [];
        for (var n in e)e.hasOwnProperty(n) && r.push({k: n, v: e[n]});
        return r
    }
    ...
    function A(e, r) {
        if (j(e))for (var n = 0, t = e.length; t > n && r(e[n], n) !== !1; n++);
    }

    function D(e) {
        return e = e || "k", function (r, n) {
            var t = r[e], i = n[e];
            return "*" === i ? -1 : "*" === t ? 1 : i.length - t.length
        }
    }

    var z, F = {}, _ = [], P = 1, B = 2, L = 3, N = 4, C = k();
    r.toUrl = C.toUrl;
    var H;
    t.amd = {};
    var Q = /require\(\s*(['"'])([^'"]+)\1\s*\)/g, G = /(\/\*([\s\S]*?)\*\/|([^:]|^)\/\/(.*)$)/gm, J = 0, K = 1, V = 2, W = 0, X = 1, Y = 2, Z = {}, er = {
        require: r,
        exports: 1,
        module: 1
    }, rr = [], nr = {}, tr = {
    ...
    r.config = function (e) {
        for (var r in tr)if (e.hasOwnProperty(r)) {
            var n = e[r], t = tr[r];
            if ("urlArgs" === r && "string" == typeof n)ur = n; else {
                var i = typeof t;
                if ("string" === i || "number" === i)tr[r] = n; else if (j(t))A(n, function (e) {
                    t.push(e)
    ...
    var ir, ar, or, ur, sr, cr, fr, dr = /^[-_a-z0-9\.]+(\/[-_a-z0-9\.]+)*$/i, vr = document.getElementsByTagName("head")[0], lr = document.getElementsByTagName("base")[0];
